...
Turn = 1
.data
BlockE BYTE "123456789ABCDEFG",0
iqra byte "Four_By_Four 4*4",0
Variable BYTE '  | ',0
...
row1 byte '__|__|__|__',0
row2 byte '  |  |  | ',0
Easy byte "Medium Level",0
...
Instruct2 BYTE "                             Instructions",0ah,0dh
			 BYTE "* Goal : ",0ah,0dh
			 BYTE "      => The goal of Tic Tac Toe is to be the first player to get Four in a row on a 4x4 grid",0ah,0dh
			 BYTE "* Playing Tic Tac Toe on a 4x4 Board",0ah,0dh
			 ...
			 BYTE "      => If all fourteen squares are filled and neither player has four in a row, the game is a draw",0ah,0dh,0
